...
> The null hypothesis is that there is no difference in the ratings between Spielberg and Burton movies. The alternative hypothesis is that there is a difference in ratings between the 2 directors.
>
> `t = 3` `p-value = 0.01`
